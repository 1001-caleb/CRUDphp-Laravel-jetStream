...
<form action="/articulos/{{$articulo->id}}" method="POST">
  ...
  <div class="mb-3">
    ...
    <input id="codigo" name="codigo" type="text" class="form-control" tabindex="1" value="{{$articulo->id}}">    
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input id="precio" name="precio" type="number" step="any" value="0.00" class="form-control" tabindex="3" value="{{$articulo->precio}}">
  </div>
